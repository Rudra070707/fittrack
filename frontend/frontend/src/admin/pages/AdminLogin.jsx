    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          animate={{
            background: [
              "radial-gradient(circle at 15% 25%, rgba(16,185,129,0.28), transparent 60%), radial-gradient(circle at 85% 35%, rgba(59,130,246,0.22), transparent 55%)",
              "radial-gradient(circle at 70% 20%, rgba(59,130,246,0.28), transparent 60%), radial-gradient(circle at 35% 80%, rgba(99,102,241,0.20), transparent 55%)",
              "radial-gradient(circle at 30% 70%, rgba(16,185,129,0.26), transparent 62%), radial-gradient(circle at 85% 60%, rgba(99,102,241,0.22), transparent 55%)",
              "radial-gradient(circle at 15% 25%, rgba(16,185,129,0.28), transparent 60%), radial-gradient(circle at 85% 35%, rgba(59,130,246,0.22), transparent 55%)",
            ],
          }}
        ...
        >
          <div className="h-full w-full bg-gradient-to-r from-emerald-500/20 via-sky-500/15 to-indigo-500/20" />
        </motion.div>
        ...
        <motion.div
          className="absolute -left-1/2 top-0 h-full w-[220%] opacity-15"
          animate={{ x: ["-10%", "10%", "-10%"] }}
          transition={{ duration: 14, repeat: Infinity, ease: "easeInOut" }}
          style={{
            background:
        ...
        <div className="absolute inset-0 opacity-[0.12] bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.12)_1px,transparent_0)] [background-size:18px_18px]" />
        <div className="absolute inset-0 opacity-[0.08] bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.10)_1px,transparent_0)] [background-size:26px_26px]" />
      ...
      <div ref={wrapRef} className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <button
            type="button"
            onClick={() => navigate("/")}
            className="relative mt-5 w-full text-center text-xs text-white/55 hover:text-white/80 transition"
